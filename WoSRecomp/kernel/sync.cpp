...
PPC_FUNC(__imp__NtWaitForSingleObjectEx)
{
    ...
    // See wos::AlertableReturn in file.cpp for why that matters here.
    if (wos::AlertableReturn(ctx, base, ctx.r5.u32, "NtWaitForSingleObjectEx"))
        return;
...
PPC_FUNC(__imp__KeWaitForSingleObject)
{
    ...
    if (wos::AlertableReturn(ctx, base, ctx.r6.u32, "KeWaitForSingleObject"))
        return;
...
PPC_FUNC(__imp__KeWaitForMultipleObjects)
{
    ...
    if (wos::AlertableReturn(ctx, base, ctx.r8.u32, "KeWaitForMultipleObjects"))
        return;
...
PPC_FUNC(__imp__NtWaitForMultipleObjectsEx)
{
    ...
    if (wos::AlertableReturn(ctx, base, ctx.r7.u32, "NtWaitForMultipleObjectsEx"))
        return;
